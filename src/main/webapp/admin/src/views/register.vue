<template>
    <div style="backgroundImage: url('/gaoxiaofangkong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫情期间高校防控系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                       ...
                       <!--<el-form-item class="select" label="老师">
                            <el-select style="width: 300px" v-model="ruleForm.diquId" placeholder="请选择老师">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 老师 的 老师
                            // if((!this.ruleForm.diquId)&& 'laoshi'==this.tableName){
                            ...
                            //// 学生 的 老师
                            // if((!this.ruleForm.diquId)&& 'xuesheng'==this.tableName){
                            //     this.$message.error('老师不能为空');
                            //     return
                            // }
